...
const Area_Simple_add: FC<Props> = (props: Props) => {
    ...
    const moveCircle = () => {
        function move(time: number) {
            ...
            _store.mouseX = _store.cos * _store.coef
            _store.mouseY = _store.sin * _store.coef
...
export default Area_Simple_add